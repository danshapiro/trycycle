...
- If you find later work, file it with the command in `<file_later_work_command>` and then stop thinking about it for this phase. Do not include filed later work in the revised plan, synthesis summary, blocker lists, plan edits, or implementation targets.
